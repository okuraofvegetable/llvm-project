...
; IS________OPM-NEXT:    [[TMP1:%.*]] = tail call i8* @foo(%pair* noalias nonnull dereferenceable(8) [[DATA]])
...
; IS__TUNIT_NPM-NEXT:    [[TMP3:%.*]] = call i8* @foo(%pair* noalias nonnull dereferenceable(8) [[DATA_PRIV]])
...
; IS__CGSCC_NPM-NEXT:    [[TMP3:%.*]] = call i8* @foo(%pair* noalias noundef nonnull align 8 dereferenceable(8) [[DATA_PRIV]])
