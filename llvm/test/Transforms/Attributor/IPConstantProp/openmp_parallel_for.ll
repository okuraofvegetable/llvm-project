...
; IS__TUNIT_NPM-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* noundef nonnull align 8 dereferenceable(24) [[GLOB0:@.*]], i32 [[TMP5]], i32 34, i32* noalias noundef nonnull align 4 dereferenceable(4) [[DOTOMP_IS_LAST]], i32* noalias noundef nonnull align 4 dereferenceable(4) [[DOTOMP_LB]], i32* noalias noundef nonnull align 4 dereferenceable(4) [[DOTOMP_UB]], i32* noalias noundef nonnull align 4 dereferenceable(4) [[DOTOMP_STRIDE]], i32 1, i32 1)
...
; IS__CGSCC_NPM-SAME: (i32* noalias nocapture readonly [[DOTGLOBAL_TID_:%.*]], i32* noalias nocapture nofree readnone [[DOTBOUND_TID_:%.*]], i32* nocapture noundef nonnull readonly align 4 dereferenceable(4) [[N:%.*]], float* nocapture noundef nonnull readonly align 4 dereferenceable(4) [[P:%.*]], i64 [[Q:%.*]])
; IS__CGSCC_NPM-NEXT:  entry:
